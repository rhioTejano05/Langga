...
yes.addEventListener("click", () => {
  ...
  text.innerHTML = "Knew it Gaa. I love you 😁😘";
  yes.innerHTML = '<a href="https://www.facebook.com/share/1E2QffF925/">Message me</a>';// inside the " " put your social media profile link
  yes.style.height = "90%";
  yes.style.width = "96%";
  no.style.display = "none";
  setTimeout(() => {
